...
class TestSmartRoom(unittest.TestCase):
    ...
    def test_something(self, mock_object: Mock):
        ...
        class TestSmartRoom(unittest.TestCase):
            ...
            def test_manage_light_level_turn_on(self, mock_led: Mock, mock_check_enough_light: Mock,
            ...
            @patch.object(Adafruit_BMP280_I2C, "temperature", new_callable=PropertyMock)
            @patch.object(SmartRoom, "change_servo_angle")
            def test_manage_window_do_nothing_if_temperatures_out_of_bound(self, mock_servo: Mock,
